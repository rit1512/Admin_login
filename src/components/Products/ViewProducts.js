...
export class ViewProducts extends Component {
   ...
   async handleClick () {
    ...
    //       <td>
    //       <Link to ={process.env.PUBLIC_URL+`/EditProduct/${item.product_id}`}> 
            ...
            <div className="page-wrapper">
               ...
               <div className="custom-table-here">
                  <div className="container">
                    ...
                    <Link to="/Products"> <button type="button" className="btn btn-info add-product-btn"><i className="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Add Prodcts</button></Link>
                            <br /><br />
                            <ReactTable 
            columns = {col}
            defaultPageSize={6}
