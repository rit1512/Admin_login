...
export class EditBrand extends Component {
  ...
  <div class="form-row">
    ...
    <label for="inputCategory">Edit Brand Name</label>
     <input type="text" className="form-control" placeholder="" name="ui_brand_name" value = {this.state.ui_brand_name} onChange={e => this.change(e)} />
    </div>
    <div class="form-group col-md-12">
    <label for="inputCategory">Edit Product_name</label>
     ...
     <select className="form-control" value = {this.state.ui_product_name} name = "ui_product_name" onChange = {(e) => this.setState({ui_product_type_id: e.target.value})}>
    ...
    <div class="form-group col-md-12">
    <label for="inputCategory">Product_ID</label>
     <textarea className="form-control" name="ui_product_id" value = {this.state.ui_product_id} onChange = {e => this.change(e)}></textarea>
    </div>
  </div>
