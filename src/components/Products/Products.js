...
<div className = "product-form-upper">
  ...
  <div class="form-row">
    ...
    <select className="form-control" name = "ui_product_type_id" value={this.state.ui_product_type_id} onChange = {e => this.change(e)}>
    ...
    <div class="form-group col-md-6">
    <label for="inputCategory">Quantity_status</label>
     <input type="text" className="form-control" placeholder="" name="ui_product_status" value = {this.state.ui_product_status} onChange = {e => this.change(e)} />
    </div>

    <div class="form-group col-md-6">
    <label for="inputSubcategory">Product Category_ID</label><br />              
    <select className="form-control" name = "ui_product_type_id" value={this.state.ui_product_type_id} onChange = {e => this.change(e)}>
      <option value="No Choice">Choose....</option>
    {
          this.state.userdata ?
