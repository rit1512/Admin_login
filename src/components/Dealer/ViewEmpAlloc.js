...
export class ViewEmpAlloc extends Component {
    ...
    handleClick () {
      axios.get(`${API_URL}product_employe/view`,axios.defaults.headers.common['authorization'] = 'Bearer ' +	authService.getToken())
      .then(response => {
  ...
  <tbody>
  {
    ...
    <td>{++serial}</td>
      ...
      {/* <td>{item.rate_given}</td>
      <td>{item.total_rate_given}</td> */}
        ...
        <div className="page-wrapper">
           ...
           <div className="custom-table-here">
              <div className="container">
                ...
                <Link to="/ViewEmploye"> <button type="button" className="btn btn-info add-employe-btn"><i className="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Allocate Employe</button></Link>
                        <br /><br />
                {empallocdata}
 {/* details modal here */} 
